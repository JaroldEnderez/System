        ...
        return (
          <Box minW="300px" maxW="800px" mx="auto" p="20px" bg="white" borderWidth='1px' borderRadius="lg" boxShadow="inner" mb="20px">
            <Flex justifyContent="space-between">
              ...
              <Link to={`/class/${projectId}/milestones`} textDecoration="bold" _hover={{ textDecoration: "none" }}>
...
useEffect(() => {
  const fetchDiscussionsUsersAndComments = async () => {
      try {
          // Fetch discussions
          const response = await axios.get(`/api/discussions/project/${projectId}`);
  ...
  // If the post was posted yesterday, display "Yesterday"
